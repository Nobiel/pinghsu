...
<div id="<?php $this->respondId(); ?>" class="comment-container">
    <div id="comments" class="clearfix">
        ...
        <form method="post" action="<?php echo str_replace("http","https",$this->commentUrl()); ?>" id="comment-form" class="comment-form" role="form" onsubmit ="getElementById('misubmit').disabled=true;return true;">
