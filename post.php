...
<article class="main-content <?php if ($this->options->postshowthumb == 'able'): ?>post-page<?php else: ?>page-page<?php endif; ?>" itemscope itemtype="http://schema.org/Article">
	...
	<div id="post-content" class="post-content" itemprop="articleBody">
		...
		<p class="post-info">
			本文由 <a href="<?php $this->author->permalink(); ?>"><?php $this->author() ?></a> 创作，最后编辑时间为: <?php echo date('M j, Y \\a\t h:i a' , $this->modified); ?><br>除非特殊说明，本站文章均采用 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" rel="external nofollow">署名-非商业性使用-相同方式共享 4.0</a> 国际许可协议进行许可<br>本站文章除注明转载/出处外，均为本站原创或翻译，转载前请务必署名
		</p>
	</div>
</article>
